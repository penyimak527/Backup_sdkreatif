...
<body>
	...
	<div class="container">
		...
		<div class="right" style="width: 240px;">
			<?php
			// Konversi tanggal dari d-m-Y ke Y-m-d agar bisa diproses
			$tanggal_input = $tanggal ?? date('d-m-Y');
			$timestamp = DateTime::createFromFormat('d-m-Y', $tanggal_input);
			$hariIndex = (int) $timestamp->format('w'); // 0: Minggu, 1: Senin, ..., 6: Sabtu
			
			// Huruf-huruf hari sesuai urutan tampilan: M S S R K J S (dari Minggu ke Sabtu)
