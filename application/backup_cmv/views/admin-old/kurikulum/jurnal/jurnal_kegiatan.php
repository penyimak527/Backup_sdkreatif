		...
		<div class="card-body">
			<div class="row">
				...
				<div class="col-md-12 mb-2">
					...
					<select class="form-control" data-choices name="tanggal">
						<option value="">Pilih Tanggal</option>
						<?php foreach ($grouped_jadwal as $tanggal_key => $items): ?>
							<option value="<?= $tanggal_key; ?>"><?= date('d-m-Y', strtotime($tanggal_key)); ?></option>
						<?php endforeach; ?>
					</select>
				</div>
				...
				<div class="col-md-3 mb-2">
					<button type="button" class="btn btn-outline-primary" id="btn-simpan">
...
<script>
	$(document).ready(function () {
		...
		$("#btn-simpan").click(function () {
			...
			$.ajax({
				url: '<?= base_url('admin/kurikulum/jurnal/jurnal_kegiatan/tambah'); ?>',
				type: 'POST',
				data: formData,
				contentType: false,
				processData: false,
