		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="row" id="form-edit" enctype="multipart/form-data">
					...
					<!-- <h3 class="mt-3">Foto Kegiatan</h3>
					<div class="col-md-6 mb-2">
						<label for="nis" class="form-label">Kegiatan Awal</label>
						<a data-lightbox="image-1" id="href-kegiatan_awal" data-title="Foto Kegiatan Awal"> <img
								id="foto_kegiatan_awal" style="max-height: 250px; width: 100%;" alt=""
								class="img-fluid"></a>
					</div>
					<div class="col-md-6 mb-2">
						<label for="nama_lengkap" class="form-label">Kegiatan Akhir</label>
						<a data-lightbox="image-1" id="href-kegiatan_akhir" data-title="Foto Kegiatan Awal"> <img
								id="foto_kegiatan_akhir" style="max-height: 250px; width: 100%;" alt=""
								class="img-fluid"></a>
					</div>
					<div class="col-sm-12">
						<h5>Data Siswa</h5>
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-small" id="table-jurnal-siswa">
								<thead>
...
<script>
	$(document).ready(function () {
		...
		$('#dt-length-0').on('change', function () {
			...
			paging($('#riwayat-mengajar'), jumlah);
		});
	})
	...
	function riwayat_mengajar_result() {
		...
		$.ajax({
			...
			success: function (data) {
						...
						<div class="card-mapel">
							...
							<div class="keterangan-mapel">
								<div class="keterangan-mapel-kiri">
									<h5 class="judul-mapel" style="margin:0; margin-top: 8px;">${item.mapel} Kelas ${item.nama_kelas}</h5>
				...
				paging($('#riwayat-mengajar'), jumlah_awal);
			}
		});
	}
	...
	function paging($selector) {
		let jumlah_tampil = parseInt($('#dt-length-0').val());

		if (typeof $selector == 'undefined') {
			$selector = $("#riwayat-mengajar .card-mapel");
		}
