<div class="card">
	...
	<div class="card-body">
		...
		<div class="table-responsive-sm">
			<table class="table table-bordered m-b-0" id="table_kelas">
				<thead>
					<tr>
...
<script>
	$(document).ready(function () {
		...
		$('#dt-length-0').on('change', function () {
			...
			paging($('#table_kelas tbody tr'), jumlah);
		});
	})
					...
					data.forEach(function (item) {
						...
						<tr>
							...
							<td> 
								...
								<button type="button" class="btn btn-sm btn-outline-danger" onclick="hapus(${item.id},${item.id_kelas})"><i class="ri-delete-bin-line"></i></button> 
							</td>
						</tr>
						`;
					});
				}
				$('#table_kelas tbody').html(table);
				let jumlah_awal = parseInt($('#dt-length-0').val());
				paging($('#table_kelas tbody tr'), jumlah_awal);
			}
		});
	}
