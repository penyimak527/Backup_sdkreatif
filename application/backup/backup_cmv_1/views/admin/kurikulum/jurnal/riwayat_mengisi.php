...
<script>
	$(document).ready(function () {
		...
		$('#dt-length-0').on('change', function () {
			...
			paging($('#riwayat-mengisi  .card-mapel'), jumlah);
		});
	})
	...
	function riwayat_mengisi_result() {
		...
		$.ajax({
			...
			success: function (data) {
							...
							<div>
								<div class="keterangan-mapel-kiri">
									...
									<div class="mt-2 d-flex justify-content-end"> 
											<button type="button" class="btn btn-sm btn-outline-warning tombol-edit" onclick="editPegawai('${detail}')">
				...
				paging($('#riwayat-mengisi .card-mapel'), jumlah_awal)
			}
		});
	}
