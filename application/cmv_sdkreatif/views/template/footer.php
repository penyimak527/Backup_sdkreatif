	...
	<div class="page-container">
		<div class="row">
			<div class="col-md-6 text-center text-md-start">
				<script>document.write(new Date().getFullYear())</script> © SD Kreatif - By <span
					class="fw-bold text-decoration-underline text-uppercase text-reset fs-12">Piramid Soft
					Indonesia</span>
			</div>
...
<script>
	...
	// 	const layoutWrapper = document.querySelector('.layout-wrapper') || document.querySelector('body');

	// 	// Set default ke sm-hover jika bukan mobile
	// 	if (window.innerWidth > 991) {
	// 		html.setAttribute('data-sidenav-size', 'sm-hover');
	// 	}

	// 	// Hover: hanya aktif jika bukan di mobile
	// 	layoutWrapper.addEventListener('mouseenter', () => {
	// 		if (window.innerWidth > 991 && html.getAttribute('data-sidenav-size') === 'sm-hover') {
	// 			html.classList.add('sidebar-hovered');
	// 		}
	// 	});

	// 	layoutWrapper.addEventListener('mouseleave', () => {
	// 		if (window.innerWidth > 991) {
	// 			html.classList.remove('sidebar-hovered');
	// 		}
	// 	});
